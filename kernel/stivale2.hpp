#ifndef STIVALE__STIVALE2_HPP
#define STIVALE__STIVALE2_HPP
...
#define STIVALE2_MMAP_FRAMEBUFFER            0x1002
    ...
    struct struct_tag_memmap
    {
        struct tag tag;
        uint64_t entries;
        struct mmap_entry memmap[];
    };
...
#define STIVALE2_STRUCT_TAG_EFI_SYSTEM_TABLE_ID 0x4bc5ec15845b558e
    ...
    struct struct_tag_efi_system_table
    {
        struct tag tag;
...
#define STIVALE2_STRUCT_TAG_KERNEL_FILE_V2_ID 0x37c13018a02c6ea2
    ...
    struct struct_tag_kernel_file_v2
    {
        struct tag tag;
        uint64_t kernel_file;
...
#define STIVALE2_STRUCT_TAG_KERNEL_SLIDE_ID 0xee80847d01506c57
    ...
    struct struct_tag_kernel_slide
    {
        struct tag tag;
...
#define STIVALE2_STRUCT_TAG_PXE_SERVER_INFO 0x29d1e96239247032
    ...
    struct struct_tag_pxe_server_info
    {
        struct tag tag;
        uint32_t server_ip;
    };
...
#define STIVALE2_STRUCT_TAG_VMAP 0xb0ed257db18cb58f
    ...
    TagType *get_tag(st2::st2_struct *st2_struct, uint64_t tag_id)
    {
        auto curr_tag = reinterpret_cast<st2::tag *>(st2_struct->tags);
        ...
        for (;;)
        {
            ...
            curr_tag = reinterpret_cast<st2::tag *>(curr_tag->next);
        }
    }
}
